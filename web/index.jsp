<%-- 
    Document   : index
    Created on : Feb 3, 2021, 4:20:41 PM
    Author     : asus
--%>
        ...
        <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron secondary-background text-white ">
                <div class="container">
                    ...
                    <h3 class="display-3">Welcome to BlogPost </h3>
                    ...
                    <button class="btn btn-outline-light btn-lg"> <span class="fa fa-id-card"></span> Start ! its Free</button>
