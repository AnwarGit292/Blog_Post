...
<%@page import="com.blog.post.dao.UserDao"%>
...
<html>
    <head>
        ...
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v9.0" nonce="wWc46eUU"></script> 
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background">
                <a class="navbar-brand" href="index.jsp">Blog Post</a>
                  ...
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="#">Project Idea</a>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" href="#" data-toggle="modal" data-target="#add-post-modal"> <span class=" fa fa-pencil-square-o"></span> Add Post</a>
                    </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row my-2 row-user">
                                <div class="col-md-8">
                                    <% UserDao ud=new UserDao(ConnetionProvider.getConnection()); %>
                        ...
                        <div class="card-footer">
                            <div class="fb-comments" data-href="http://localhost:8080/BlogPost/show_blog_page.jsp?post_id= <%= p.getPid() %>" data-width="" data-numposts="5"></div>
                          ...
                          <form id="add-post-form" action="AddPostServlet" method="post">
                              ...
                              <div class="form-group">
                                  <select class="form-control" name="cid">
                                      ...
                                      <% 
                                      PostDao postd=new PostDao(ConnetionProvider.getConnection());
                              ...
                              <div class="form-group">
                                  <textarea name="pCode" class="form-control" style="height: 200px;" placeholder="Enter your programe (if any) "></textarea>
                              </div>  
                              <div class="form-group"> 
